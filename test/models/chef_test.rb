...
class ChefTest < ActiveSupport::TestCase
	...
	test "eamil length should be within bounds"do
    ...
    test "email validation should accept valid address"do
      valid_addresses=%w[user@eee.com R_TDD-DS@eee.hello.org user@exmaple.com first.last@eee.au laura+joe@monk.cm]
